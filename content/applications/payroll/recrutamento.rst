...
Recrutamento
============
Explore mais sobre as nossas integrações com os portais de emprego portugueses: publique as vagas
do Odoo diretamente a partir da app **Recrutamento**, sem ter de repetir o anúncio em cada
plataforma
...
Net-Empregos
============
O `Net-Empregos <https://www.net-empregos.com>`_ é um dos maiores portais de emprego em Portugal.
...
SAPO Emprego
============
O `SAPO Emprego <https://emprego.sapo.pt>`_ é outro dos maiores portais de emprego em Portugal.
