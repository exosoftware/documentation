...
O objetivo desta documentação não é sobrepor-se ao conteúdo nativo do Odoo, mas sim:

- informar sobre as funcionalidades extra que a **Localização PT+** da **Exo Software** acrescenta ao Odoo
- mostrar quais são os processos mais corretos para que a sua experiência cumpra os requisitos legais em vigor em Portugal
...
.. important::
    Avisos sobre pequenos problemas que podem surgir, seja no uso do Odoo ou no cumprimento das obrigações legais e fiscais
...
Para que possa tirar o melhor proveito da nossa documentação, sugerimos que comece por consultar a secção :doc:`Configuração inicial <../administration/install/initial_configuration>`
