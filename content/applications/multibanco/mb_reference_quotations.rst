...
seja pelo menu **Ações** do documento, seja porque o cliente escolheu Multibanco ao pagar no
...
.. image:: mb_reference_quotations/v18_mb_reference_quotations_settings.png
    :align: center
...
Depois de configurada, a geração é automática e não tem passos adicionais: sempre que imprimir ou
enviar um orçamento que ainda não tenha referência, o Odoo cria uma antes de produzir o PDF

Para imprimir, abra o menu **Ações** (o ícone de engrenagem ao lado do número do documento) e
escolha :menuselection:`Imprimir --> Orçamento / Encomenda`. Para enviar ao cliente, use o botão
**Enviar por E-mail**

.. image:: mb_reference_quotations/v18_mb_reference_quotations_print.png
    :align: center
...
.. image:: mb_reference_quotations/v18_mb_reference_quotations_report.png
    :align: center
